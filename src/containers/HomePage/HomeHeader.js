  ...
  searchData = (event) => {
    ...
    if (!_.isEmpty(keyword)) {
      ...
      doctorFilter = this.state.doctorData.filter((item) => {
        return (
          upperCase(item.lastName).includes(keyword) ||
          upperCase(item.firstName).includes(keyword)
        );
      });
      doctorFilter = doctorFilter
        .slice(0, 5)
        .map((obj) => ({ ...obj, link: `/detail-doctor/${obj.id}` }));
      ...
      specialtyFilter = specialtyFilter
        .slice(0, 5)
        .map((obj) => ({ ...obj, link: `/detail-specialty/${obj.id}` }));
      ...
      clinicFilter = clinicFilter
        .slice(0, 5)
        .map((obj) => ({ ...obj, link: `/detail-clinic/${obj.id}` }));
          ...
          <div className="home-header-banner">
            <div className="content-up">
              ...
              <div className="search">
                ...
                >
                  {doctorFilter && doctorFilter.length > 0 && (
                    <div className="header-search">Thông tin bác sĩ</div>
                  )}
                  {doctorFilter &&
                  ...
                  {specialtyFilter && specialtyFilter.length > 0 && (
                    <div className="header-search">Thông tin chuyên khoa</div>
                  )}
                  {specialtyFilter &&
                  ...
                  {clinicFilter && clinicFilter.length > 0 && (
                    <div className="header-search">Thông tin phòng khám</div>
                  )}
                  {clinicFilter &&
                    clinicFilter.length > 0 &&
              ...
              <div className="options">
                <div className="option-child">
                  ...
                  <div className="text-child">
                    <FormattedMessage id={"banner.speacialist-examination"} />
                  </div>
                </div>
                <div className="option-child">
                  <div className="icon-child">
                ...
                <div className="option-child">
                  ...
                  <div className="text-child">
                    <FormattedMessage id={"banner.dentis-examination"} />
                  </div>
                </div>
              </div>
            </div>
