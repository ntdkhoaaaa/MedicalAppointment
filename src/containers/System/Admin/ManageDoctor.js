      ...
      allClinics.forEach((element) => {
        ...
        let comparation =
          language === LANGUAGES.VI
            ? element.name.localeCompare(selectedInfor.label)
            : element.nameEn.localeCompare(selectedInfor.label);
        console.log(comparation);
        if (comparation === 0) {
          this.setState({
            addressClinic:
              language === LANGUAGES.VI ? element.address : element.addressEn,
          });
        }
      });
    }
      ...
      <div className="manage-doctor-container">
        ...
        <div className="more-info">
          ...
          <div className="content-right">
            ...
            <textarea
              onChange={(event) =>
                this.handleOnChangeTextforTextArea(event, "description")
              }
        ...
        <div className="more-infor-extra row">
          ...
          <div className="col-2 form-group">
            <label>
              <FormattedMessage id="admin.manage-doctor.maximun-patient-in-same-time" />
            </label>
            <input
